        ...
        <div className="space-y-6 pt-0">
            <div className="space-y-4">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <span className="font-semibold text-gray-900">Social App Usage:</span>
                        <span className="text-gray-700 ml-1">Daily active time increased by 30%.</span>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-gray-600 rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                        <span className="font-semibold text-gray-900">GPS Data (New Locations Visited per Week):</span>
                        <span className="text-gray-700 ml-1">Average 1 new non-routine location/week</span>
                    </div>
                </div>
                <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-gray-600 rounded-full mt-2 flex-shrink-0"></div>
