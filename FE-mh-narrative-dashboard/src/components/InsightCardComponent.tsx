...
export default function InsightCardComponent({
    ...
    return (
        <Card
            className={`w-full min-w-[200px] transition-all duration-200 hover:shadow-md border text-left 
            ${isInsightCardSelected ? "bg-gray-100 border-gray-300 ring-2 ring-blue-500" : "bg-white border-gray-200"}`}>
