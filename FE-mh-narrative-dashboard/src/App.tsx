...
function App() {
  ...
  const [selectedInsightCard, setSelectedInsightCard] = useState<number | null>(
    null
  );
      ...
      <div className="w-full flex flex-1 bg-white min-h-0 flex-col sm:flex-row">
        <div
          className={`overflow-y-scroll p-4 ${
            isDrillDown
              ? "basis-full sm:basis-1/3 flex-none"
              : "basis-full flex-none"
          }`}
        >
          <div className="relative flex basis-full">
            ...
            <div className="flex-1 flex-col gap-4 pl-6">
              <SectionTitle
                title="Overview"
                subtitle="test"
