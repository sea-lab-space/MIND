...
export default function BaselinePage() {
  ...
  const { passiveSensingFacts = [] }: { passiveSensingFacts?: any[] } =
  ...
  if (invalidPatient) {
    return (
      <div>
        ...
        <p>
          The patient ID you entered is invalid. Please select a valid patient.
        </p>
    ...
    return {
      ...
      label: (
        <div className="flex items-center gap-2">
          {iconConfig && <span className="font-bold">{iconConfig.icon}</span>}
