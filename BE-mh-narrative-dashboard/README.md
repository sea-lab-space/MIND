...
## Running Insight Discovery

Run the following command in the terminal: `python run_pipeline.py`.

As of now, go into the `run_pipeline.py` file to adjust the simulated patient you wanted to run.
